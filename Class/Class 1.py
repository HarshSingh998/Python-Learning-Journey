...
""" There Are 3 Rule to follow variables - 
...
# Example Of anything can become variables 
sher = 12
chacha = 54
hellono1 = 41
print (sher)
...
Example -> 3.14 , 44.52 , 544434.65745 , 12/5 , 10/2 , 18/9 """

""" complex - Real + imaginary number :-  3+4j ( here we use iota = j ) """

""" str - you can save anything inside quotes
here we use ( '' ) or ( " " ) 
For string and it is anything in keyboard ( Name , Number , Special Characters ) """
...
# Kisi bhi data type ko check kr skte ho ki wo konsa type hai -> Checking the Type 
